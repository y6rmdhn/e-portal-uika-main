                ...
                <div class="grid lg:grid-cols-2">
                    <div class="flex flex-col h-full p-10">
                        ...
                        <div class="pb-6 my-auto text-center">
                            ...
                            <p class="text-gray-300 mb-5 max-w-sm mx-auto"><b>Sign In</b><br>Portal UIKA sistem informasi dari Universitas Ibn Khaldun Bogor.</p>
                            ...
                            <form class="form text-start" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="block w-full rounded py-1.5 px-3 bg-transparent border-white/10 border-gray-200 text-white/80 focus:border-white/25 focus:ring-transparent" name="password" type="password" required="" id="password" placeholder="Enter your password">
                                </div>
                                <!-- end password input -->
                                <div class="mb-6">
                                    <a href="{{ url('forget') }}" class="text-gray-200 float-right border-b border-dashed"><small>Forgot your password?</small></a>
                                    <input type="checkbox" class="h-4 w-4 rounded border-white/20 bg-white/20 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary/60 focus:ring-offset-0" id="checkbox-signin">
                                    <label class="ms-2 text-gray-200 align-middle" for="checkbox-signin">Remember me</label>
                                </div>
                                <!-- end checkbox input -->
                                <div class="mb-6 text-center">
                                    <button class="w-full inline-flex items-center justify-center px-6 py-2 backdrop-blur-2xl bg-white/20 text-white rounded-lg transition-all duration-500 group hover:bg-primary/20 hover:text-primary mt-5" type="submit">
                            ...
                            <div class="pb-6">
                                <div class="text-center">
                                    ...
                                    <div class="flex flex-wrap items-center justify-center gap-2">
                                        <a href="{{ route('redirect') }}" class="h-10 p-2 inline-flex items-center justify-center backdrop-blur-2xl bg-white/20 rounded-lg transition-all duration-500 group hover:bg-primary/60 text-white">
                                            <img src="https://tias.ti.ft.uika-bogor.ac.id/img/google.png" width="25" alt=""> &nbsp;&nbsp; Google
                                        </a>
                                    </div><!-- end social -->
                                </div>
                            </div>
                        ...
                        <div class="w-full text-center">
                            <p class="text-gray-300 leading-6 text-base font-medium">Don't have an account? <a href="{{ url('regist') }}" class="text-primary font-semibold ms-1">Sign Up</a></p>
                        </div>
                    </div> <!-- end col -->
