<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="../assets/img/logo_uika.png" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 text-lg font-weight-bold">PORTAL UIKA</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto h-auto ps" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @can('users-management')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('link-items') ? 'active' : '' }} " href="{{ url('link-items') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('link-items') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                        <span class="nav-link-text ms-1">Link Items</span>
                    </a>
                </li>
            @endcan
            @can('users-management')
            ...
            <li class="nav-item">
                <a class="nav-link " href="javascript:void(0);" onClick="logouts()">
