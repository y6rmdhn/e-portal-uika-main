            ...
            <div class="card card-body blur shadow-blur mx-4 mt-n6">
                <div class="row gx-4">
                    <div class="col-auto">
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#modalAdmin" type="button" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="adminModalLabel">Edit Image</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <input type="file" class="form-control" placeholder="image" name="image"
                                id="image" aria-label="Image" aria-describedby="image" value="{{ old('image') }}">
                            @error('image')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
